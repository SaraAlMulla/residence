...
describe MessagesController do
  ...
  def valid_attributes
    { :date_read => 2.days.ago, :date_sent => 10.days.ago, :receiver_id=> 1,
     :sender_id=> 1, :subject => "important"}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update_attributes).with({ "subject" => "MyString" })
